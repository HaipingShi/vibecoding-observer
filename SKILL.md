...
```bash
vibecoding-observer --source all --claude-dir /custom/claude/projects --codex-dir /custom/codex/sessions --output /tmp/vibecoding_observer_report
```
...
### Step 5: Generate diagnostic consulting routes
